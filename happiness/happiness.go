...
func AskHappinessSurvey(s *common.Slack, ev *slack.MessageEvent) error {
	text := ev.Text
...
func ResultHappinessSurvey(userid, result string) error {
...
// Ask how are the users doing
func AskHappinessSurveyScheduled(s *common.Slack, userid string) error {
